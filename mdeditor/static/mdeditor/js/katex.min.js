!function (t, e) {
    ...
    return function (t) {
        ...
        var m = function t(e) {
                ...
                }, getBaseElem: m, isCharacterBox: function (t) {
                    var e = m(t);
        ...
        var z = {
                ...
                return e.hasClass = function (t) {
                    ...
                    var t = "<img  src='" + this.src + " 'alt='" + this.alt + "' ", e = "";
            ...
            E = function () {
                function t(t, e, r, a, n, i, o, s) {
                    ...
                    var h = function (t) {
                        for (var e = 0; e < k.length; e++) for (var r = k[e], a = 0; a < r.blocks.length; a++) {
                            var n = r.blocks[a];
        ...
        var W = {bin: 1, close: 1, inner: 1, open: 1, punct: 1, rel: 1},
            X = {"accent-token": 1, mathord: 1, "op-token": 1, spacing: 1, textord: 1}, _ = {math: {}, text: {}}, j = _;

        function $(t, e, r, a, n, i) {
            _[t][n] = {font: e, group: r, replace: a}, i && a && (_[t][a] = _[t][n])
        }

        var Z = "main", K = "ams", J = "bin", Q = "mathord", tt = "op-token", et = "rel";
        ...
        var xt = [["mathbf", "textbf", "Main-Bold"], ["mathbf", "textbf", "Main-Bold"], ["mathdefault", "textit", "Math-Italic"], ["mathdefault", "textit", "Math-Italic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["boldsymbol", "boldsymbol", "Main-BoldItalic"], ["mathscr", "textscr", "Script-Regular"], ["", "", ""], ["", "", ""], ["", "", ""], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathfrak", "textfrak", "Fraktur-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["mathbb", "textbb", "AMS-Regular"], ["", "", ""], ["", "", ""], ["mathsf", "textsf", "SansSerif-Regular"], ["mathsf", "textsf", "SansSerif-Regular"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathboldsf", "textboldsf", "SansSerif-Bold"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["mathitsf", "textitsf", "SansSerif-Italic"], ["", "", ""], ["", "", ""], ["mathtt", "texttt", "Typewriter-Regular"], ["mathtt", "texttt", "Typewriter-Regular"]],
            ...
            yt = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488], wt = function (t, e) {
        ...
        var St = kt, Mt = {
                ...
                sp: 1 / 65536,
                px: 1.00375
            }, zt = {ex: !0, em: !0, mu: !0}, At = function (t) {
                return "string" != typeof t && (t = t.unit), t in Mt || t in zt || "ex" === t
            }, Tt = function (t, e) {
                var r;
                if (t.unit in Mt) r = Mt[t.unit] / e.fontMetrics().ptPerEm / e.sizeMultiplier; else if ("mu" === t.unit) r = e.fontMetrics().cssEmPerMu; else {
                    var a;
                    if (a = e.style.isTight() ? e.havingStyle(e.style.text()) : e, "ex" === t.unit) r = a.fontMetrics().xHeight; else {
            ...
            Ct = function (t, e, r) {
                ...
                fontMap: Ht, makeSymbol: qt, mathsym: function (t, e, r, a) {
                ...
                }, makeSpan: Rt, makeSvgSpan: Ot, makeLineSpan: function (t, e, r) {
                    var a = Rt([t], [], e);
                    ...
                    var n = new I(t, e, r, a);
                    return It(n), n
                }, makeFragment: Et, wrapFragment: function (t, e) {
                    ...
                    for (var m = [], c = n, u = n, p = n, d = 0; d < a.length; d++) {
                        ...
                        if ("kern" === f.type) p += f.size; else {
                            var g = f.elem, x = f.wrapperClasses || [], v = f.wrapperStyle || {},
                                b = Rt(x, [l, g], void 0, v);
                    ...
                    var a, n = t.mode, i = t.text, s = ["mord"], h = "math" === n || "text" === n && e.font,
                    ...
                    var r = Rt(["mspace"], [], e), a = Tt(t, e);
                    return r.style.marginRight = a + "em", r
                }, staticSvg: function (t, e) {
                    var r = Pt[t], a = r[0], n = r[1], i = r[2], o = new H(a), s = new L([o], {
                        width: n + "em",
                        height: i + "em",
                        style: "width:" + n + "em",
                ...
                }, svgData: Pt, tryCombineChars: function (t) {
        ...
        var Wt = {number: 3, unit: "mu"}, Xt = {number: 4, unit: "mu"}, _t = {number: 5, unit: "mu"}, jt = {
        ...
        var ee = function (t) {
                var e = Vt(t, "ordgroup");
                return e ? e.body : [t]
            }, re = Dt.makeSpan, ae = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
            ne = ["rightmost", "mrel", "mclose", "mpunct"],
            ie = {display: w.DISPLAY, text: w.TEXT, script: w.SCRIPT, scriptscript: w.SCRIPTSCRIPT}, oe = {
                mord: "mord",
                mop: "mop",
                mbin: "mbin",
                mrel: "mrel",
                ...
                var m = re([a[0] || "leftmost"], [], e), u = re([a[1] || "rightmost"], [], e);
                return he(n, function (t, e) {
                    var r = e.classes[0], a = t.classes[0];
                    "mbin" === r && c.contains(ne, a) ? e.classes[0] = "mord" : "mbin" === a && c.contains(ae, r) && (t.classes[0] = "mord")
                }, {node: m}, u), he(n, function (t, e) {
                    var r = me(e), a = me(t), n = r && a ? t.hasClass("mtight") ? $t[r][a] : jt[r][a] : null;
                ...
                for (var i = 0; i < e.length; i++) {
                    var o = e[i], s = le(o);
                    if (s) t(s.children, r, a); else if ("mspace" !== o.classes[0]) {
                        var h = r(o, a.node);
        ...
        function de(t, e) {
            ...
            for (var a, n = se(t, e, !0), i = [], o = [], s = 0; s < n.length; s++) if (o.push(n[s]), n[s].hasClass("mbin") || n[s].hasClass("mrel") || n[s].hasClass("allowbreak")) {
        ...
        var ge = function () {
            ...
            MathNode: ge, TextNode: xe, SpaceNode: function () {
                function t(t) {
        ...
        function ze(t, e, r, a) {
            ...
            var s = new ve.MathNode("semantics", [n, o]), h = new ve.MathNode("math", [s]);
        ...
        var Ae = function (t) {
                ...
                var r = function () {
                    var r = 4e5, a = t.label.substr(1);
                    if (c.contains(["widehat", "widecheck", "widetilde", "utilde"], a)) {
                        var n, i, o, s = Ne(t.base);
                        if (s > 5) "widehat" === a || "widecheck" === a ? (n = 420, r = 2364, o = .42, i = a + "4") : (n = 312, r = 2340, o = .34, i = "tilde4"); else {
                            var h = [1, 1, 2, 2, 3, 3][s];
                    ...
                    if (1 === y) u = ["hide-tail"], p = [f[3]]; else if (2 === y) u = ["halfarrow-left", "halfarrow-right"], p = ["xMinYMin", "xMaxYMin"]; else {
                ...
                }(), a = r.span, n = r.minWidth, i = r.height;
                ...
                var o = ue(r, e.havingCrampedStyle()), s = 0;
        ...
        Qt({
            ...
            handler: function (t, e) {
                var r = e[0], a = !He.test(t.funcName),
            ...
            props: {numArgs: 1},
            handler: function (t, e) {
                var r = t.parser, a = t.funcName, n = e[0];
                return {type: "accentUnder", mode: r.mode, label: a, base: n}
            },
            htmlBuilder: function (t, e) {
                var r = ue(t.base, e), a = Oe(t, e), n = "\\utilde" === t.label ? .12 : 0, i = Dt.makeVList({
                    positionType: "bottom",
            ...
            mathmlBuilder: function (t, e) {
                var r = Re(t.label), a = new ve.MathNode("munder", [Me(t.base, e), r]);
        ...
        Qt({
            ...
            htmlBuilder: function (t, e) {
                ...
                var o, s = Oe(t, e), h = -e.fontMetrics().axisHeight + .5 * s.height,
                ...
                if ((i.depth > .25 || "\\xleftequilibrium" === t.label) && (l -= i.depth), r) {
                    ...
                    o = Dt.makeVList({
                        ...
                        children: [{type: "elem", elem: i, shift: l}, {type: "elem", elem: s, shift: h}, {
                            type: "elem",
                            elem: r,
                            shift: m
                        }]
        ...
        var De = function (t, e) {
            ...
            var r = ke(t.body, e.withColor(t.color)), a = new ve.MathNode("mstyle", r);
        ...
        Qt({
            ...
            handler: function (t, e) {
                var r = t.parser, a = Ft(e[0], "color-token").color, n = e[1];
            ...
            handler: function (t, e) {
                var r = t.parser, a = t.breakOnTokenText, n = Ft(e[0], "color-token").color;
            ...
            handler: function (t, e, r) {
                var a = t.parser, n = t.funcName, i = r[0], o = "\\cr" === n, s = !1;
        ...
        var Ve = function (t, e, r) {
                ...
                var n = r.havingBaseStyle(e), i = Dt.makeSpan(a.concat(n.sizingClasses(r)), [t], r),
                    o = n.sizeMultiplier / r.sizeMultiplier;
                return i.height *= o, i.depth *= o, i.maxFontSize = n.sizeMultiplier, i
            }, Ge = function (t, e, r) {
                var a = e.havingBaseStyle(r), n = (1 - e.sizeMultiplier / a.sizeMultiplier) * e.fontMetrics().axisHeight;
                ...
                }(t, e, n, a), s = Ue(Dt.makeSpan(["delimsizing", "size" + e], [o], a), w.TEXT, a, i);
            ...
            }, Xe = {type: "kern", size: -.005}, _e = function (t, e, r, a, n, i) {
                var o, s, h, l;
                o = h = l = t, s = null;
                var m = "Size1-Regular";
                ...
                var c = Ve(o, m, n), u = c.height + c.depth, p = Ve(h, m, n), d = p.height + p.depth, f = Ve(l, m, n),
                    g = f.height + f.depth, x = 0, v = 1;
                if (null !== s) {
                    var b = Ve(s, m, n);
                    x = b.height + b.depth, v = 2
                }
                var y = u + g + x, k = Math.max(0, Math.ceil((e - y) / (v * d))), S = y + k * v * d,
                    M = a.fontMetrics().axisHeight;
                r && (M *= a.sizeMultiplier);
                var z = S / 2 - M, A = .005 * (k + 1) - d, T = [];
                if (T.push(We(l, m, n)), null === s) for (var B = 0; B < k; B++) T.push(Xe), T.push(We(h, m, n)); else {
            ...
            Ke = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"], Je = [0, 1.2, 1.8, 2.4, 3],
            Qe = [{type: "small", style: w.SCRIPTSCRIPT}, {type: "small", style: w.SCRIPT}, {
                type: "small",
                style: w.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {type: "large", size: 4}],
            tr = [{type: "small", style: w.SCRIPTSCRIPT}, {type: "small", style: w.SCRIPT}, {
                type: "small",
                style: w.TEXT
            }, {type: "stack"}], er = [{type: "small", style: w.SCRIPTSCRIPT}, {type: "small", style: w.SCRIPT}, {
                type: "small",
                style: w.TEXT
            }, {type: "large", size: 1}, {type: "large", size: 2}, {type: "large", size: 3}, {
                type: "large",
                size: 4
            }, {type: "stack"}], rr = function (t) {
                ...
                for (var n = Math.min(2, 3 - a.style.size); n < r.length && "stack" !== r[n].type; n++) {
                    var i = Ve(t, rr(r[n]), "math"), o = i.height + i.depth;
                ...
                return "small" === s.type ? function (t, e, r, a, n, i) {
                    var o = Dt.makeSymbol(t, "Main-Regular", n, a), s = Ue(o, e, a, i);
                    return r && Ge(s, a, e), s
                }(t, s.style, r, a, n, i) : "large" === s.type ? Ye(t, s.size, r, a, n, i) : _e(t, e, r, a, n, i)
            }, ir = function (t, e) {
                var r, a, n = e.havingBaseSizing(), i = ar("\\surd", t * n.sizeMultiplier, er, n), o = n.sizeMultiplier,
                    s = Math.max(0, e.minRuleThickness - e.fontMetrics().sqrtRuleThickness), h = 0, l = 0, m = 0;
            ...
            }, sr = nr, hr = function (t, e, r, a, n, i) {
                var o = a.fontMetrics().axisHeight * a.sizeMultiplier, s = 5 / a.fontMetrics().ptPerEm,
                    h = Math.max(e - o, r + o), l = Math.max(h / 500 * 901, 2 * h - s);
        ...
        Qt({
            ...
            type: "leftright", names: ["\\left"], props: {numArgs: 1}, handler: function (t, e) {
                ...
                if (i *= e.sizeMultiplier, o *= e.sizeMultiplier, r = "." === t.left ? ce(e, ["mopen"]) : hr(t.left, i, o, e, t.mode, ["mopen"]), n.unshift(r), s) for (var l = 1; l < n.length; l++) {
                    var m = n[l].isMiddle;
                    m && (n[l] = hr(m.delim, i, o, m.options, t.mode, []))
                }
                if ("." === t.right) a = ce(e, ["mclose"]); else {
        ...
        var pr = function (t, e) {
            var r, a, n = Dt.wrapFragment(ue(t.body, e), e), i = t.label.substr(1), o = e.sizeMultiplier, s = 0,
                h = c.isCharacterBox(t.body);
            if ("sout" === i) (r = Dt.makeSpan(["stretchy", "sout"])).height = e.fontMetrics().defaultRuleThickness / o, s = -.5 * e.fontMetrics().xHeight; else {
            ...
            return a = t.backgroundColor ? Dt.makeVList({
                positionType: "individualShift",
                children: [{type: "elem", elem: r, shift: s}, {type: "elem", elem: n, shift: 0}]
            }, e) : Dt.makeVList({
                positionType: "individualShift",
                children: [{type: "elem", elem: n, shift: 0}, {
                    type: "elem",
                    elem: r,
                    shift: s,
            ...
            var r = 0, a = new ve.MathNode(t.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [Me(t.body, e)]);
            switch (t.label) {
                case"\\cancel":
        ...
        Qt({
            ...
            handler: function (t, e, r) {
                var a = t.parser, n = t.funcName, i = Ft(e[0], "color-token").color, o = e[1];
            ...
            handler: function (t, e, r) {
                var a = t.parser, n = t.funcName, i = Ft(e[0], "color-token").color, o = Ft(e[1], "color-token").color,
                    s = e[2];
            ...
            props: {numArgs: 1},
            handler: function (t, e, r) {
                var a = t.parser, n = t.funcName, i = e[0];
        ...
        function vr(t, e, r) {
            var a = e.hskipBeforeAndAfter, n = e.addJot, i = e.cols, s = e.arraystretch, h = e.colSeparationType;
            if (t.gullet.beginGroup(), t.gullet.macros.set("\\\\", "\\cr"), !s) {
                var l = t.gullet.expandMacroAsText("\\arraystretch");
                if (null == l) s = 1; else if (!(s = parseFloat(l)) || s < 0) throw new o("Invalid \\arraystretch: " + l)
            }
            t.gullet.beginGroup();
            var m = [], c = [m], u = [], p = [];
            for (p.push(xr(t)); ;) {
                ...
                t.gullet.endGroup(), t.gullet.beginGroup(), d = {
                    ...
                    mode: t.mode,
                    body: d
                }, r && (d = {type: "styling", mode: t.mode, style: r, body: [d]}), m.push(d);
                var f = t.fetch().text;
                if ("&" === f) t.consume(); else {
                    if ("\\end" === f) {
        ...
        var yr = function (t, e) {
            var r, a, n = t.body.length, i = t.hLinesBeforeRow, s = 0, h = new Array(n), l = [],
                m = Math.max(e.fontMetrics().arrayRuleWidth, e.minRuleThickness), u = 1 / e.fontMetrics().ptPerEm,
                p = 5 * u;
            t.colSeparationType && "small" === t.colSeparationType && (p = e.havingStyle(w.SCRIPT).sizeMultiplier / e.sizeMultiplier * .2778);
            var d = 12 * u, f = 3 * u, g = t.arraystretch * d, x = .7 * g, v = .3 * g, b = 0;

            function y(t) {
                for (var e = 0; e < t.length; ++e) e > 0 && (b += .25), l.push({pos: b, isDashed: t[e]})
            }

            for (y(i[0]), r = 0; r < t.body.length; ++r) {
                var k = t.body[r], S = x, M = v;
            ...
            for (a = 0, q = 0; a < s || q < I.length; ++a, ++q) {
                for (var O = I[q] || {}, E = !0; "separator" === O.type;) {
                    ...
                    var L = "|" === O.separator ? "solid" : "dashed", H = Dt.makeSpan(["vertical-separator"], [], e);
        ...
        }, wr = {c: "center ", l: "left ", r: "right "}, kr = function (t, e) {
            ...
            var n = "", i = "";
            if (t.cols) {
                var o = t.cols, s = "", h = !1, l = 0, m = o.length;
            ...
            var r, a = [], n = vr(t.parser, {cols: a, addJot: !0}, "display"), i = 0,
                s = {type: "ordgroup", mode: t.mode, body: []}, h = Vt(e[0], "ordgroup");
            if (h) {
            ...
            n.body.forEach(function (t) {
                ...
                if (c) i < t.length && (i = t.length); else {
                    var n = t.length / 2;
        ...
        gr({
            ...
            }, htmlBuilder: yr, mathmlBuilder: kr
        }), gr({
            type: "array",
            ...
            handler: function (t) {
                var e = {
                    ...
                    vmatrix: ["|", "|"],
                    Vmatrix: ["\\Vert", "\\Vert"]
                }[t.envName], r = vr(t.parser, {hskipBeforeAndAfter: !1}, br(t.envName));
                return e ? {type: "leftright", mode: t.mode, body: [r], left: e[0], right: e[1], rightColor: void 0} : r
            },
            htmlBuilder: yr,
            mathmlBuilder: kr
        }), gr({
            type: "array", names: ["smallmatrix"], props: {numArgs: 0}, handler: function (t) {
                var e = vr(t.parser, {arraystretch: .5}, "script");
                return e.colSeparationType = "small", e
            }, htmlBuilder: yr, mathmlBuilder: kr
        }), gr({
            type: "array", names: ["subarray"], props: {numArgs: 1}, handler: function (t, e) {
        ...
        Qt({
            ...
            handler: function (t, e) {
                ...
                if ("\\begin" === a) {
                    ...
                    var h = Mr[i], l = r.parseArguments("\\begin{" + i + "}", h), m = l.args, c = l.optArgs,
                        u = {mode: r.mode, envName: i, parser: r}, p = h.handler(u, m, c);
                    r.expect("\\end", !1);
                    var d = r.nextToken, f = Ft(r.parseFunction(), "environment");
        ...
        Qt({
            ...
            handler: function (t, e) {
                var r = t.parser, a = t.funcName, n = e[0], i = a;
            ...
            props: {numArgs: 1, greediness: 2},
            handler: function (t, e) {
                var r = t.parser, a = e[0], n = c.isCharacterBox(a);
                return {
                    type: "mclass",
                    mode: r.mode,
                    mclass: Br(a),
            ...
            handler: function (t, e) {
                var r = t.parser, a = t.funcName, n = t.breakOnTokenText, i = r.mode, o = r.parseExpression(!0, n);
                return {
                    type: "font",
                    mode: i,
                    font: "math" + a.slice(1),
        ...
        var Ir = function (t, e) {
            ...
            if (t.continued) {
                var s = 8.5 / e.fontMetrics().ptPerEm, h = 3.5 / e.fontMetrics().ptPerEm;
            ...
            if (t.hasBarLine ? (t.barSize ? (m = Tt(t.barSize, e), l = Dt.makeLineSpan("frac-line", e, m)) : l = Dt.makeLineSpan("frac-line", e), m = l.height, c = l.height) : (l = null, m = 0, c = e.fontMetrics().defaultRuleThickness), a.size === w.DISPLAY.size || "display" === t.size ? (u = e.fontMetrics().num1, p = m > 0 ? 3 * c : 7 * c, d = e.fontMetrics().denom1) : (m > 0 ? (u = e.fontMetrics().num2, p = c) : (u = e.fontMetrics().num3, p = 3 * c), d = e.fontMetrics().denom2), l) {
                ...
                f = Dt.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: b, shift: d}, {type: "elem", elem: l, shift: k}, {
                        type: "elem",
                        elem: o,
                        shift: -u
                    }]
                ...
                S < p && (u += .5 * (p - S), d += .5 * (p - S)), f = Dt.makeVList({
                    positionType: "individualShift",
                    children: [{type: "elem", elem: b, shift: d}, {type: "elem", elem: o, shift: -u}]
                }, e)
            }
        ...
        var Er = ["display", "text", "script", "scriptscript"], Lr = function (t) {
            var e = null;
        ...
        Qt({
            ...
            handler: function (t, e) {
                var r = t.parser, a = e[4], n = e[5], i = Vt(e[0], "atom");
                i && (i = Ut(e[0], "open"));
                var o = i ? Lr(i.text) : null, s = Vt(e[1], "atom");
                s && (s = Ut(e[1], "close"));
                var h, l = s ? Lr(s.text) : null, m = Ft(e[2], "size"), c = null;
                h = !!m.isBlank || (c = m.value).number > 0;
                var u = "auto", p = Vt(e[3], "ordgroup");
                if (p) {
                    if (p.body.length > 0) {
            ...
            handler: function (t, e) {
                var r = t.parser, a = (t.funcName, t.token);
                return {
                    type: "infix",
                    mode: r.mode,
            ...
            handler: function (t, e) {
                var r = t.parser, a = (t.funcName, e[0]), n = function (t) {
                    if (!t) throw new Error("Expected non-null, but got " + String(t));
                    return t
                }(Ft(e[1], "infix").size), i = e[2], o = n.number > 0;
                return {
                    type: "genfrac",
                    mode: r.mode,
                    numer: a,
        ...
        var Hr = function (t, e) {
            ...
            if (a.isOver ? (o = Dt.makeVList({
                positionType: "firstBaseline",
                children: [{type: "elem", elem: s}, {type: "kern", size: .1}, {type: "elem", elem: h}]
            }, e)).children[0].children[0].children[1].classes.push("svg-align") : (o = Dt.makeVList({
                positionType: "bottom",
                positionData: s.depth + .1 + h.height,
                children: [{type: "elem", elem: h}, {type: "kern", size: .1}, {type: "elem", elem: s}]
        ...
        Qt({
            ...
            handler: function (t, e) {
                var r = t.parser, a = e[1], n = Ft(e[0], "url").url;
            ...
            handler: function (t, e) {
                var r = t.parser, a = Ft(e[0], "url").url;
        ...
        Qt({
            ...
            handler: function (t, e, r) {
                var a = t.parser, n = {number: 0, unit: "em"}, i = {number: .9, unit: "em"},
                    s = {number: 0, unit: "em"}, h = "";
                if (r[0]) for (var l = Ft(r[0], "raw").string.split(","), m = 0; m < l.length; m++) {
                    var c = l[m].split("=");
                    if (2 === c.length) {
                        var u = c[1].trim();
                        switch (c[0].trim()) {
            ...
            handler: function (t, e) {
                var r = t.parser, a = t.funcName, n = Ft(e[0], "size");
            ...
            htmlBuilder: function (t, e) {
                ...
                var a = Dt.makeSpan(["fix"], []), n = Dt.makeSpan([t.alignment], [r, a], e), i = Dt.makeSpan(["strut"]);
            ...
            handler: function (t, e) {
                var r = t.funcName, a = t.parser, n = a.mode;
                a.switchMode("math");
        ...
        var Fr = function (t, e, r, a, n, i, o) {
            ...
            if (h && s) {
                ...
                l = Dt.makeVList({
                    ...
                    children: [{type: "kern", size: a.fontMetrics().bigOpSpacing5}, {
                        ...
                        elem: s.elem,
                        marginLeft: -i + "em"
                    }, {type: "kern", size: s.kern}, {type: "elem", elem: t}, {
                        type: "kern",
                        size: h.kern
                ...
                l = Dt.makeVList({
                    positionType: "bottom",
                    positionData: d,
                    children: [{type: "elem", elem: t}, {type: "kern", size: h.kern}, {
                        type: "elem",
                        elem: h.elem,
                        marginLeft: i + "em"
            ...
            if (h.size === w.DISPLAY.size && n.symbol && !c.contains(Vr, n.name) && (l = !0), n.symbol) {
                var m = l ? "Size2-Regular" : "Size1-Regular", u = "";
                if ("\\oiint" !== n.name && "\\oiiint" !== n.name || (u = n.name.substr(1), n.name = "oiint" === u ? "\\iint" : "\\iiint"), s = Dt.makeSymbol(n.name, m, "math", e, ["mop", "op-symbol", l ? "large-op" : "small-op"]), u.length > 0) {
                    var p = s.italic, d = Dt.staticSvg(u + "Size" + (l ? "2" : "1"), e);
                    s = Dt.makeVList({
                        positionType: "individualShift",
                        children: [{type: "elem", elem: s, shift: 0}, {type: "elem", elem: d, shift: l ? .08 : 0}]
            ...
            var r;
            if (t.symbol) r = new ge("mo", [be(t.name, t.mode)]), c.contains(Vr, t.name) && r.setAttribute("largeop", "false"); else if (t.body) r = new ge("mo", ke(t.body, e)); else {
        ...
        Qt({
            ...
            mathmlBuilder: function (t, e) {
                for (var r = ke(t.body, e.withFont("mathrm")), a = !0, n = 0; n < r.length; n++) {
                    var i = r[n];
                    if (i instanceof ve.SpaceNode) ; else if (i instanceof ve.MathNode) switch (i.type) {
                        case"mi":
                        case"mn":
                        case"ms":
                        case"mspace":
            ...
            type: "overline", names: ["\\overline"], props: {numArgs: 1}, handler: function (t, e) {
                ...
                var r = ue(t.body, e.havingCrampedStyle()), a = Dt.makeLineSpan("overline-line", e),
                    n = e.fontMetrics().defaultRuleThickness, i = Dt.makeVList({
                        positionType: "firstBaseline",
            ...
            mathmlBuilder: function (t, e) {
                var r = ke(ee(t.body), e), a = new ve.MathNode("mphantom", r), n = new ve.MathNode("mpadded", [a]);
            ...
            htmlBuilder: function (t, e) {
                var r = Dt.makeSpan(["inner"], [ue(t.body, e.withPhantom())]), a = Dt.makeSpan(["fix"], []);
            ...
            handler: function (t, e) {
                var r = t.parser, a = Ft(e[0], "size").value, n = e[1];
                return {type: "raisebox", mode: r.mode, dy: a, body: n}
            },
            htmlBuilder: function (t, e) {
                var r = ue(t.body, e), a = Tt(t.dy, e);
                return Dt.makeVList({positionType: "shift", positionData: -a, children: [{type: "elem", elem: r}]}, e)
            },
            mathmlBuilder: function (t, e) {
                var r = new ve.MathNode("mpadded", [Me(t.body, e)]), a = t.dy.number + t.dy.unit;
            ...
            handler: function (t, e, r) {
                var a = t.parser, n = r[0], i = Ft(e[0], "size"), o = Ft(e[1], "size");
                return {type: "rule", mode: a.mode, shift: n && Ft(n, "size").value, width: i.value, height: o.value}
            },
            htmlBuilder: function (t, e) {
                var r = Dt.makeSpan(["mord", "rule"], [], e), a = Tt(t.width, e), n = Tt(t.height, e),
            ...
            mathmlBuilder: function (t, e) {
                var r = Tt(t.width, e), a = Tt(t.height, e), n = t.shift ? Tt(t.shift, e) : 0,
                    i = e.color && e.getColor() || "black", o = new ve.MathNode("mspace");
        ...
        Qt({
            type: "sizing", names: jr, props: {numArgs: 0, allowedInText: !0}, handler: function (t, e) {
                var r = t.breakOnTokenText, a = t.funcName, n = t.parser, i = n.parseExpression(!1, r);
                return {type: "sizing", mode: n.mode, size: jr.indexOf(a) + 1, body: i}
            }, htmlBuilder: function (t, e) {
                var r = e.havingSize(t.size);
                return _r(t.body, r, e)
            }, mathmlBuilder: function (t, e) {
                var r = e.havingSize(t.size), a = ke(t.body, r), n = new ve.MathNode("mstyle", a);
            ...
            handler: function (t, e, r) {
                var a = t.parser, n = !1, i = !1, o = r[0] && Ft(r[0], "ordgroup");
                if (o) for (var s = "", h = 0; h < o.body.length; ++h) {
                    if ("t" === (s = o.body[h].text)) n = !0; else {
                        if ("b" !== s) {
                            n = !1, i = !1;
                            break
                        }
            ...
            type: "sqrt", names: ["\\sqrt"], props: {numArgs: 1, numOptionalArgs: 1}, handler: function (t, e, r) {
                ...
                var a = e.fontMetrics().defaultRuleThickness, n = a;
                e.style.id < w.TEXT.id && (n = e.fontMetrics().xHeight);
                var i = a + n / 4, o = r.height + r.depth + i + a, s = ir(o, e), h = s.span, l = s.ruleWidth,
                    m = s.advanceWidth, c = h.height - l;
                ...
                var p = Dt.makeVList({
                    ...
                    children: [{type: "elem", elem: r, wrapperClasses: ["svg-align"]}, {
                        type: "kern",
                        size: -(r.height + u)
                    }, {type: "elem", elem: h}, {type: "kern", size: l}]
                }, e);
                if (t.index) {
                    var d = e.havingStyle(w.SCRIPTSCRIPT), f = ue(t.index, d, e), g = .6 * (p.height - p.depth),
                        x = Dt.makeVList({
                            positionType: "shift",
                            positionData: -g,
                            children: [{type: "elem", elem: f}]
                        }, e), v = Dt.makeSpan(["root"], [x]);
                    return Dt.makeSpan(["mord", "sqrt"], [v, p], e)
                }
                return Dt.makeSpan(["mord", "sqrt"], [p], e)
            }, mathmlBuilder: function (t, e) {
                var r = t.body, a = t.index;
        ...
        Qt({
            ...
            props: {numArgs: 0, allowedInText: !0},
            handler: function (t, e) {
                var r = t.breakOnTokenText, a = t.funcName, n = t.parser, i = n.parseExpression(!0, r),
                    o = a.slice(1, a.length - 5);
                return {type: "styling", mode: n.mode, style: o, body: i}
            },
            htmlBuilder: function (t, e) {
                var r = $r[t.style], a = e.havingStyle(r).withFont("");
                return _r(t.body, a, e)
            },
            mathmlBuilder: function (t, e) {
                var r = $r[t.style], a = e.havingStyle(r), n = ke(t.body, a), i = new ve.MathNode("mstyle", n), o = {
                    display: ["0", "true"],
                    text: ["0", "false"],
                    script: ["1", "false"],
        ...
        te({
            type: "supsub", htmlBuilder: function (t, e) {
                ...
                if (r) return r(t, e);
                var a, n, i, o = t.base, s = t.sup, h = t.sub, l = ue(o, e), m = e.fontMetrics(), u = 0, p = 0,
                ...
                if (a && n) {
                    ...
                    var z = [{type: "elem", elem: n, shift: p, marginRight: b, marginLeft: y}, {
                        type: "elem",
                        elem: a,
                        shift: -u,
                        marginRight: b
                ...
                var i, o = [Me(t.base, e)];
                if (t.sub && o.push(Me(t.sub, e)), t.sup && o.push(Me(t.sup, e)), a) i = r ? "mover" : "munder"; else if (t.sub) if (t.sup) {
                    var s = t.base;
        ...
        te({
            type: "mathord", htmlBuilder: function (t, e) {
                ...
                var r = new ve.MathNode("mi", [be(t.text, t.mode, e)]), a = we(t, e) || "italic";
        ...
        var ta = {
                ...
                "\\texttt": "texttt",
                "\\textnormal": "textrm"
            }, ea = {"\\textbf": "textbf", "\\textmd": "textmd"}, ra = {"\\textit": "textit", "\\textup": "textup"},
            aa = function (t, e) {
                var r = t.font;
        ...
        Qt({
            ...
            htmlBuilder: function (t, e) {
                var r = ue(t.body, e), a = Dt.makeLineSpan("underline-line", e),
                    n = e.fontMetrics().defaultRuleThickness, i = Dt.makeVList({
                        positionType: "top",
        ...
        pa("\\char", function (t) {
            ...
            if ("'" === r.text) e = 8, r = t.popToken(); else if ('"' === r.text) e = 16, r = t.popToken(); else if ("`" === r.text) if ("\\" === (r = t.popToken()).text[0]) a = r.text.charCodeAt(1); else {
            ...
            return e.feed = function (t) {
                ...
                for (var e = [], r = 0; r < t; ++r) {
                    ...
                    if ("{" === a.text) {
                        for (var n = [], i = 1; 0 !== i;) {
                            var s = this.popToken();
                            if (n.push(s), "{" === s.text) ++i; else if ("}" === s.text) --i; else if ("EOF" === s.text) throw new o("End of input in macro argument", a)
                        }
                ...
                var a = r.tokens;
                if (r.numArgs) for (var n = this.consumeArgs(r.numArgs), i = (a = a.slice()).length - 1; i >= 0; --i) {
                    var s = a[i];
                    if ("#" === s.text) {
                        if (0 === i) throw new o("Incomplete placeholder at end of macro body", s);
                        if ("#" === (s = a[--i]).text) a.splice(i + 1, 1); else {
            ...
            return e.expect = function (t, e) {
                ...
                for (; ;) {
                    ...
                    if ("\\limits" === n.text || "\\nolimits" === n.text) {
                        ...
                        if ("'" !== n.text) break;
                        if (e) throw new o("Double superscript", n);
                        var l = {type: "textord", mode: this.mode, text: "\\prime"}, m = [l];
                ...
                var a = this.fetch(), n = a.text, i = ia[n];
                if (!i) return null;
                ...
                var s = this.parseArguments(n, i), h = s.args, l = s.optArgs;
                return this.callFunction(n, h, l, a, t)
            }, e.callFunction = function (t, e, r, a, n) {
                var i = {funcName: t, parser: this, token: a, breakOnTokenText: n}, s = ia[t];
                ...
                for (var a = e.greediness, n = [], i = [], s = 0; s < r; s++) {
                    var h = e.argTypes && e.argTypes[s], l = s < e.numOptionalArgs,
                ...
                if (r ? "[" === u : "{" === u || "\\begingroup" === u) {
                    ...
                    var d = this.parseExpression(!1, p), f = this.fetch();
                ...
                } else if (r) m = null; else if (null == (m = this.parseFunction(i, e, n) || this.parseSymbol()) && "\\" === u[0] && !ya.hasOwnProperty(u)) {
                ...
                if (this.consume(), s) for (var u = 0; u < s[0].length; u++) {
                    var p = s[0][u];
            ...
            __renderToHTMLTree: function (t, e) {
                ...
                try {
                    return function (t, e, r) {
                        var a = de(t, Ae(r)), n = Dt.makeSpan(["katex"], [a]);
                        return Te(n, r)
                    }(za(t, r), 0, r)
                } catch (e) {
                    return Ta(e, t, r)
